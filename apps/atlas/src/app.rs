...
impl AtlasContext {
    ...
    fn settings_window(&mut self, ui: &mut egui::Ui) {
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Min), |ui| {
            ui.text_edit_singleline(&mut self.napkin_temp_settings.model);
            ui.label("Model: ");
        });
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Min), |ui| {
            ui.text_edit_singleline(&mut self.napkin_temp_settings.service.host);
            ui.label("Host: ").rect.set_width(80.0);
        });
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Min), |ui| {
            ui.text_edit_singleline(&mut self.napkin_temp_settings.service.port);
            ...
            egui::menu::bar(ui, |ui| {
                ...
                ui.menu_button("File", |ui| {
                    ...
                    if ui.button("Settings").clicked() {
                        ...
                        self.tree.push_to_focused_leaf("Settings".to_owned());
                        self.context.buffers.insert(
                            "Settings".to_owned(),
                            PanelTab {
                ...
                if ui.button("About").clicked() {
                    self.context.about_window_open = true;
                }

                ui.with_layout(egui::Layout::right_to_left(egui::Align::Max), |ui| {
                    ui.horizontal(|ui| match self.context.theme {
                        Theme::Dark => {
                            if ui
                                .button("☀")
                                ...
                                .clicked()
                            {
                                self.context.theme = Theme::Light;
                            }
                        }
                        Theme::Light => {
                            if ui
                                ...
                                .clicked()
                            {
                                self.context.theme = Theme::Dark;
                            }
                        }
                    });
                    ui.toggle_value(&mut self.context.side_panel_open, "File Browser");
                });
            });
        });
